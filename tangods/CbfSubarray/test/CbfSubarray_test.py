        ...
        for receptor in jones_matrix["jonesMatrix"][1]["matrixDetails"]:
            for frequency_slice in receptor["receptorMatrix"]:
                for i in frequency_slice["matrix"]:
                    ...
                    try:
                        assert create_vcc_proxies[vcc_id-1].jonesMatrix[fs_id-1][i] == i
                    except AssertionError:
                        logging.error("AssertionError; incorrect Jones matrix entry: epoch {}, VCC {}, i = {}, jonesMatrix[{}] = {}".format(
                            jones_matrix["jonesMatrix"][1]["epoch"], vcc_id, i, fs_id-1, create_vcc_proxies[vcc_id-1].jonesMatrix[fs_id-1])
                        )
            ...
            for frequency_slice in receptor["receptorMatrix"]:
                for i in frequency_slice["matrix"]:
                    ...
                    try:
                        ...
                        logging.error("AssertionError; incorrect Jones matrix entry: epoch {}, VCC {}, i = {}, jonesMatrix[{}] = {}".format(jones_matrix["jonesMatrix"][1]["epoch"], vcc_id, i, fs_id-1, create_vcc_proxies[vcc_id-1].jonesMatrix[fs_id-1]))
                        return AssertionError
                    except Exception:
                        pass
