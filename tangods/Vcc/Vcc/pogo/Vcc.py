...
class Vcc(SKACapability):
    ...
    **Properties:**
    ...
    def init_device(self):
        ...
        # In this way a client can subscribe to the VCC subarrayMemebership attribute even when the polling is not set.
        # the reportVccsubarrayMemebership attribute evaluated by the CbfMaster is updated as soon as it receives all the events generated by the VCCs (with no delay due to the polling time).
