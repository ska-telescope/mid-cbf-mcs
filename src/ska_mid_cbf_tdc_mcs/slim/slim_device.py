...
from ska_mid_cbf_tdc_mcs.device.base_device import CbfDevice, CbfFastCommand
from ska_mid_cbf_tdc_mcs.slim.slim_component_manager import SlimComponentManager
