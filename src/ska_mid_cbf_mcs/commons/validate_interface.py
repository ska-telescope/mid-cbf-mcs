...
CSP_CONFIGSCAN_VER5_0 = CSP_CONFIGSCAN_PREFIX + "5.0"
...
CSP_CONFIGSCAN_VERSIONS = [CSP_CONFIGSCAN_VER4_1, CSP_CONFIGSCAN_VER5_0]
CSP_MID_DELAYMODEL_VERSIONS = [CSP_MID_DELAYMODEL_VER3_0]
CSP_SCAN_VERSIONS = [
    CSP_SCAN_VER2_2,
    CSP_SCAN_VER2_3,
]
CBF_INITSYSPARAM_VERSIONS = [CBF_INITSYSPARAM_VER1_0, CBF_INITSYSPARAM_VER1_1]
