...
Generic subarray device for Mid.CBF
"""
...
class CbfSubarrayDevice(CspSubElementObsDevice):
    """
    A generic base subarray device for Mid.CBF.
    ...
    def longRunningCommandsInQueue(self: CbfSubarrayDevice) -> list[str]:
        """
    ...
    def longRunningCommandIDsInQueue(self: CbfSubarrayDevice) -> list[str]:
        """
    ...
    def longRunningCommandStatus(self: CbfSubarrayDevice) -> list[str]:
        """
    ...
    def longRunningCommandProgress(self: CbfSubarrayDevice) -> list[str]:
        """
...
def main(*args: str, **kwargs: str) -> int:
    ...
    :return: exit code
    """
    return cast(int, CbfSubarrayDevice.run_server(args=args or None, **kwargs))
