...
class TalonLRUComponentManager(CbfComponentManager):
    ...
    def check_power_mode(
        ...
        if self._proxy_power_switch1 is not None:
            if self._proxy_power_switch1.numOutlets != 0:
                self.pdu1_power_mode = self._proxy_power_switch1.GetOutletPowerMode(self._pdu_outlets[0])
            else:
                self.pdu1_power_mode = PowerMode.UNKNOWN
        else:
            self.pdu1_power_mode = PowerMode.UNKNOWN
        ...
        if (self.pdu1_power_mode == expected_power_mode and
    ...
    def on(      
        ...
        if self.connected:
            ...
            if self._proxy_power_switch1 is not None:
                result1 = self._proxy_power_switch1.TurnOnOutlet(self._pdu_outlets[0])[0][0]
            ...
            if self._proxy_power_switch2 is not None:
                result2 = self._proxy_power_switch2.TurnOnOutlet(self._pdu_outlets[1])[0][0]
    ...
    def off(      
        ...
        if self.connected:
            ...
            result1 = ResultCode.FAILED
            if self._proxy_power_switch1 is not None:
                result1 = self._proxy_power_switch1.TurnOffOutlet(self._pdu_outlets[0])[0][0]
                if result1 == ResultCode.OK:
                    self.pdu1_power_mode = PowerMode.OFF
            ...
            result2 = ResultCode.FAILED
            if self._proxy_power_switch2 is not None:
                result2 = self._proxy_power_switch2.TurnOffOutlet(self._pdu_outlets[1])[0][0]
                if result2 == ResultCode.OK:
                    self.pdu2_power_mode = PowerMode.OFF
