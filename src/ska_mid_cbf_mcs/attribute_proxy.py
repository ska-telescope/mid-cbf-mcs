...
class CbfAttributeProxy:
    ...
    * Ability to subscribe to change events via the
    ...
    def check_initialised(self: CbfAttributeProxy, max_time: float = 120.0) -> bool:
        """
        ...
        def _backoff_check_initialised(device: tango.AttributeProxy) -> bool:
            """
            Check that the device has completed initialisation.
        ...
        def _check_initialised(device: tango.AttributeProxy) -> bool:
            """
            Check that the device has completed initialisation.
    ...
    def _read(self: CbfAttributeProxy, attribute_name: str) -> Any:
        """
