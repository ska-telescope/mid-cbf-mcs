...
PYTHON_VARS_AFTER_PYTEST = --forked -k TalonLRU# additional pytest flags; use -k to isolate particular tests to run for unit/integration, e.g. -k CbfSubarray for subarray tests
