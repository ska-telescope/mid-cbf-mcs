...
PYTHON_VARS_AFTER_PYTEST = -k test_configure_scan_in_the_middle_of_scanning # additional pytest flags; use -k to isolate particular tests to run for unit/integration, e.g. -k CbfSubarray for subarray tests
